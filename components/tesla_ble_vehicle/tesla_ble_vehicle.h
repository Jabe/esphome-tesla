...
namespace esphome
{
    ...
    namespace tesla_ble_vehicle
    {
        ...
        protected:
            ...
            binary_sensor::BinarySensor *isClimateOnSensor{nullptr};
            binary_sensor::BinarySensor *isBootOpenSensor{nullptr};
            binary_sensor::BinarySensor *isFrunkOpenSensor{nullptr};
            binary_sensor::BinarySensor *windowsStateSensor{nullptr};
            text_sensor::TextSensor *ShiftStateSensor{nullptr};
            text_sensor::TextSensor *DefrostStateSensor{nullptr};
            text_sensor::TextSensor *ChargingStateSensor{nullptr};
            text_sensor::TextSensor *ChargePortLatchStateSensor{nullptr};
            text_sensor::TextSensor *LastUpdateStateSensor{nullptr};
            sensor::Sensor *ChargeStateSensor{nullptr};
            sensor::Sensor *OdometerStateSensor{nullptr};
            ...
            sensor::Sensor *BatteryRangeStateSensor{nullptr};
            sensor::Sensor *outsideTempStateSensor{nullptr};
            sensor::Sensor *insideTempStateSensor{nullptr};
            sensor::Sensor *ChargeEnergyAddedSensor{nullptr};
            sensor::Sensor *ChargeDistanceAddedSensor{nullptr};
            sensor::Sensor *TpmsPressureFlSensor{nullptr};
            sensor::Sensor *TpmsPressureFrSensor{nullptr};
            sensor::Sensor *TpmsPressureRlSensor{nullptr};
            sensor::Sensor *TpmsPressureRrSensor{nullptr};
